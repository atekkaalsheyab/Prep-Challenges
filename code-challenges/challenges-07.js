...
const cvFormatter = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        if (arr[i].yearsOfExperience > 1) {
            ...
            newCVarr.push(new newCV(fullname, arr[i].tech));
...
const applicationsStatics = (arr) => {
    // write your code here
    function newCV(python_total, javascript_total, dotnet_total, java_total) {
        this.python_devs = python_total;
        this.javaScript_devs = javascript_total;
        this.dotNet_devs = dotnet_total;
        this.java = java_total;
        this.totalApplicants = function () {
            return this.python_total + javascript_total + dotnet_total + java_total;
        }
    }
    newCV.prototype.rejectedApplicants = function () {
        if (arr[i].yearsOfExperience > 1) {
